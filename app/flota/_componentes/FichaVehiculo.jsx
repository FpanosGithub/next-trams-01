  ...
  return(
    ...
    <div className="grid grid-cols-2 gap-1 past-sm:grid-cols-3 past-md:grid-cols-4 2xl:grid-cols-6 3xl:grid-cols-8">
      ...
      <div className="rounded-md px-4 py-4 border border-slate-500 h-[13rem]">
          ...
          <div className="rounded-md mt-2 p-1 h-10 text-lg font-extralight text-center border border-slate-500">{vehiculo.owner}</div>
          <div className="text-xs text-slate-300 mt-4">Keeper:</div>
          <div className="rounded-md mt-2 p-1 h-10 text-lg font-extralight text-center border border-slate-500">{vehiculo.keeper}</div>
      </div>
    ...
    <div className="rounded-md px-4 py-4 border border-slate-500 h-[13rem]">
    <div className="text-xs text-slate-300">Último Mantenimiento:</div>
        <div className="rounded-md mt-2 py-1 px-2 h-10 text-center  text-slate-400 border border-slate-500">{vehiculo.fecha_ultimo_mantenimiento}</div> 
        <div className="mt-2 text-xs text-slate-300">Próximo Mantenimiento:</div>
